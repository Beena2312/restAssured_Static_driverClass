...
public class Utility_commonFunctions {
     ...
     File newfile=new File("C:\\Users\\HP\\OneDrive\\Desktop\\Eclips\\" +filename +".txt");
     ...
     public static ArrayList<String> readdataexcel(String sheetname,String testcasename) throws IOException 
{
            ...
            FileInputStream fis=new FileInputStream("C:\\Users\\HP\\OneDrive\\Desktop\\Eclips\\testdata.xlsx");
